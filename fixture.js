...
firebase.database().ref("/fixtures/").orderByChild("fixture_date").once("value").then(function (snapshot) {
    snapshot.forEach(function (childSnapshot) {
        ...
        fixtureList(name, date, address, price, buggy, mobFactor, timings, food, comments, i,uid);
        userList(i)
        i+=1
    })
});
//.then(document.getElementById("createFixture").addEventListener("click", create_fixture(),false));
...
//add function as an option into SELECT
...
//Collapsible list
function fixtureList(name, date, address, price, buggy, mobFactor, timings, food, comments, i, uid) {
        ...
        <li>
            ...
            <div class="collapsible-body white"> 
                ...
                <div class="row"> 
                    ...
                    <select class="browser-default" id="prefTime" >
                        <option value="" disabled selected>Choose your option</option>
                        <option value="dMind">Don't Mind</option>
                ...
                <div>
                    <input type="button" class="btn btn-lg btn-primary" value="Book Fixture" id="createFixture" onclick="create_fixture('${uid}',${i})">
                </div>
            </div>
...
/*
<div>
<input type="button" class="btn btn-lg btn-primary" value="Book Fixture"
id="createFixture"
onclick="create_fixture(${uid},${i})">
</div>
*/
